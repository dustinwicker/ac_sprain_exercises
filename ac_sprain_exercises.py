...
os.chdir('/Users/dustinwicker/Documents')
...
stretches = [("Laying on affected side, elbow on surface with fingers sticking up - bring back of hand to ground", '3 x 30 sec'),
             ...
             ("", "")] # Add space separator between stretches and exercises
...
exercises = [("Pistons","1 x 25", 5),
             ("Small circles - CW", "1 x 10", 10),
             ("Small circles - CCW", "1 x 10", 10),
             ("Drop to side (make L)", "1 x 10", 10),
             ...
             ("Hammer curls", "1 x 20", 15),
             ("Bicep curls", "1 x 20", 15),
             ...
             ("Reverse fly on pec deck (palms down)", "2 x 10", 50),
             ("Reverse fly on pec deck (palms up)", "2 x 10", 50),
             ("Incline Press", "3 x 10", 10),
             ("Lat Pull Down", "2 x 10", 75),
             ("Lat Pull Down - undergrip (bicep curl)", "2 x 10", 75),
             ("Seated Machine Back Row (palms facing each other)", "3 x 10", 75),
             ("Rebounder (modified - laying on ground and throwing ball in air)", "1 x 25", 6),
             ("Dips", "2 x 15", "70 (Using assisted weight machine)"),
             ("Chinups", "2 x 15", "70 (Using assisted weight machine)"),
